...
const newsData = [
  {
    date: "2026-04-10",
    title: "DOST ATLANTIS Project: Applied AI and Software Engineering for Smart Agriculture",
    summary: "Dr. Francis Jesmar P. Montalbo contributes as project staff, scientist, and software engineer/developer for the DOST ATLANTIS automated greenhouse initiative for lettuce and tilapia production.",
    expandedSummary: "This government-backed innovation signal shows Dr. Francis Jesmar P. Montalbo's ability to move beyond publication output and contribute to working smart-technology systems. The ATLANTIS project connects software engineering, automation, intelligent agriculture, and applied research in a setting with clear public value.",
    impact: "Government-backed applied innovation",
    proof: "Automated greenhouse system for lettuce and tilapia",
    sourceName: "DOST-PCAARRD",
  ...
  },
  {
    ...
    summary: "Dr. Francis Jesmar P. Montalbo was recognized by Batangas State University among faculty with higher Scopus h-index values, reinforcing measurable research impact through citations and publications.",
    expandedSummary: "In the university recognition update dated March 25, 2026, Dr. Francis Jesmar P. Montalbo of the College of Informatics and Computing Sciences was featured among faculty with strong Scopus h-index and research impact indicators. This gives visitors a source-backed signal of scholarly visibility, citation performance, and sustained publication strength.",
    impact: "Institutional research-impact recognition",
    proof: "Recognized for higher Scopus h-index visibility",
    sourceName: "Batangas State University",
  ...
  {
    date: "2026-05-05",
    title: "National Spotlight: OneNews Feature on Stanford-Listed Scientists",
    summary: "Dr. Francis Jesmar P. Montalbo appears in OneNews coverage connected to Stanford-listed scientists, strengthening public visibility around his high-impact AI and biomedical research profile.",
    expandedSummary: "The OneNews feature adds a national media signal to Dr. Francis Jesmar P. Montalbo's search presence. It reinforces his standing as a Filipino AI research scientist with internationally visible work in deep learning, biomedical signal processing, medical imaging, and deployable intelligent systems.",
    impact: "National media visibility",
    proof: "Coverage connected to Stanford-listed scientists",
    sourceName: "OneNews",
  ...
  },
  {
    ...
    summary: "Dr. Francis Jesmar P. Montalbo was selected as one of the Best Presenters at ICBSP 2023 in Singapore, reflecting strong communication of advanced work in biomedical imaging, signal processing, and applied AI.",
    expandedSummary: "This international conference distinction presents Dr. Francis Jesmar P. Montalbo as both a productive researcher and an effective scientific communicator. It supports a well-rounded professional profile for collaboration, invited talks, academic partnerships, and cross-border research programs.",
    impact: "International conference distinction",
    proof: "Best Presenter recognition at ICBSP 2023",
    sourceName: "ICBSP 2023",
